  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-20">
      ...
      >
        ...
        <motion.p variants={fadeUp} transition={{ duration: 0.6 }} className="opacity-60 text-lg">{t('menu.subtitle')}</motion.p>
      </motion.div>
          ...
          <AnimatePresence mode="wait">
            {filtered.map((item) => {
              ...
              return (
                ...
                >
                  <Card
                    className="border transition-all hover:-translate-y-1 h-full"
                    style={{ backgroundColor: '#0D1A0F', borderColor: `${tColor}33` }}
                  >
                    <div className="h-2 rounded-t-xl" style={{ backgroundColor: tColor }} />
