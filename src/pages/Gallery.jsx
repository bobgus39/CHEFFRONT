  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-20">
      <div className="text-center mb-12">
        ...
        <p className="opacity-60 text-lg">{t('gallery.subtitle')}</p>
      </div>
        ...
        {items.map((item, idx) => {
          ...
          return (
            <div
              ...
              className="cursor-pointer rounded-xl overflow-hidden break-inside-avoid transition-all hover:scale-[1.02] hover:shadow-xl"
